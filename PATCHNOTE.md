...
## 📅 [v1.3.0] - 2026-08-27 (Retroactive / Backdate Workout Log)

### 🚀 Manual & Backdate Workout Logging (ระบบบันทึกย้อนหลัง)
- **+ บันทึกย้อนหลัง:** เพิ่มปุ่ม `+ บันทึกย้อนหลัง` ในแท็บประวัติ & สถิติ
- **Backdate Modal:** หน้าต่างเลือกวันที่ย้อนหลัง (Date Picker), เลือกโปรแกรมที่เล่น (จันทร์, พุธ, ศุกร์, เดินสวนเกษตร, วันพัก หรือกำหนดเอง), ปรับเวลา (นาที), แคลอรี่ และบันทึกโน้ตเพิ่มเติม
- **Automatic History Chronology:** จัดเรียงประวัติและคำนวณสถิติความต่อเนื่อง (Streak 🔥) ตามลำดับวันที่ย้อนหลังให้อัตโนมัติ
- **Cloud & Local Sync:** บันทึกย้อนหลังจะซิงค์ขึ้น Cloud Firestore และ LocalStorage ทันที
